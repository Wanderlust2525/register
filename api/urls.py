...
urlpatterns = [
    ...
    path('workers/<int:worker_id>/update-delete/', UpdateDeleteWorkerView.as_view(), name='update-delete-worker'),
    path('workers/professions/', ProfessionListView.as_view(), name='worker-professions'),
